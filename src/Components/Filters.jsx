...
function Filters(props) {
    ...
    const refMobileFilters = useOutsideClick(() => setMobileFilters(false))

    return (
        <>
            <div ref={locationFilterOpen ? refLocation : null} className='locationSearchDiv mobile420Hide'>
            ...
            <div className={`mobileFilters ${mobileFilters ? 'mobilesFiltersDivOpen' : ''}`} ref={refMobileFilters}>
                <button className='generalInput' onClick={() => {
                    setMobileFilters(prevMobileFilters => !prevMobileFilters)
                    disableScroll()
                }}>Filters <span className='arrow'></span></button>
                {mobileFilters && <div className='mobileFiltersDiv'>
                    <div ref={locationFilterOpen ? refLocation : null} className='locationSearchDiv mobile420Display'>
                        {/* https://github.com/hibiken/react-places-autocomplete */}
                        <PlacesAutocomplete
                            value={locationValue}
                            onChange={setLocationValue}
                    ...
                    <div className='fiterMobileButton'>
            ...
            {(locationCoordinates || props.minPrice || props.maxPrice || props.minBaths || props.minBeds || props.homeTypes.length != 0) && <div className='removeFiltersDiv'>
